...
Als DNS Server wird die IP 9.9.9.9 gesetzt. Dieser DNS Server wird  von einer Non-Profit Stiftung namens "quad9" betrieben, die den Fokus auf Datenschutz beim DNS Server Betrieb legt. 8.8.8.8 ist der DNS von Google, das Unternehmen welches für Datensammlung bekannt ist. Daher ist die Auswahl des Servers von quad9 deutlich sinnvoller in Bezug auf Datenschutz. Zusätzlich werden Seiten, die mit Phishing oder Malware zu tun haben können blockiert während bei Google keinen Schutz bietet. 
