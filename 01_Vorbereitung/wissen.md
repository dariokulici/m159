...
| ---------------------------- | --------- | --------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| LDAP / LDAPS                 | 389 / 636 | Lighweight Directory Access Protocol (Secure) | TCP           | Zugriffsprotokoll für Abfragen und Änderungen, Directory Server Kommunikation, Authentifizierung / Autorisierung von Nutzerdaten und Kennwörtern, eines von vier zentralen Standardprotokollen von Active Directory | Benutzer loggt sich bei einem Domain gejointen Gerät ein und sendet Anmeldeinformation über LDAP. |
| Kerberos                     |           |                                               |               |                                                                                                                                                                                                                     |                                                                                                   |
| RPC                          |           |                                               |               |                                                                                                                                                                                                                     |                                                                                                   |
| Global Catalog               |           |                                               |               |                                                                                                                                                                                                                     |                                                                                                   |
| Global Catalog SSL           |           |                                               |               |                                                                                                                                                                                                                     |                                                                                                   |
...
| ICMP                         | -         | Internet Control Message Protocol             | ICMP          | Pingen von Geräten, Erreichbarkeit prüfen                                                                                                                                                                           | Von einem PC einen DNS Server pingen mit `ping 8.8.8.8`                                           |
